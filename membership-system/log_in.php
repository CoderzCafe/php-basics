...
if(!empty($_POST["submit_button"])) {
    ...
    if(empty($_POST["userEmail"]) || empty($_POST["userPassword"])) {
        exit("<b>Please fill all the form.</b><a href='./log_in.php'>Return</a>");
    }
    ...
    if($db->error) {
        exit("<b>SQL error</b><a href='./log_in.php'></a>");
    }

    if($result->num_rows === 0) {
        exit("<b>Account does not exist.</b><a href='./log_in.php'>Return</a>");
    }
    ...
    if($password === $array["user_password"]) {
        ...
        exit("<b>Wrong password.!.</b><a href='./log_in.php'></a>");
    }
}
